      ...
      <div class="flex-auto">
        <div class="max-w-3xl mx-auto pt-10 xl:max-w-none xl:ml-0 xl:mr-[15.5rem] xl:pr-16">
          <header id="header" class="relative z-20">
            ...
            <p class="mt-2 text-lg text-red-700 dark:text-red-400" v-if="isUniqueNotFoundWords"><a href="/api/translations-logs/unique-not-found-words/csv" target="_blank">Download CSV (all unique words by method)</a></p>
          </header>
