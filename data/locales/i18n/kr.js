export default {
  ...
  kr: '한국인',
  ua: '우크라이나어',
  russianDictionary: '러시아어 사전',
  buryad: '부랴트어',
  buryadNames: '부랴트 이름',
  clear: '청소하기',
  buryadDictionary: '부랴트아 사전',
  switchLanguage: '언어 변경하기',
  showFullKeyboard: '키보드 보여주기',
  todayTranslated: '오늘의 번역한 것',
  keyboardLayouts: '키보드 레이아웃',
  games: '게임',
  names: '이름',
  quiz: '퀴즈',
  localizedForBuryadLanguageGames: '부랴트어 단어',
  translate: '번역하기',
  title: '부랴트어-러시아어 사전',
  ...
  toggleLanguage: '단어 전환하기',
  dailyTranslationsCount: '오늘의 번역한 것',
  inputNameToSearch: 'Нэрэ бэшэгты олохын түлөө',
  notFount: '그것은 설립되지 않았다'
}
