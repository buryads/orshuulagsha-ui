...
<!--        <nuxt-link :to="switchLocalePath('bur')" class="px-2 py-1 cursor-pointer hover:bg-gray-200 hover:text-gray-700 text-sm rounded mb-5">-->
<!--          <outline-information-circle-icon class="w-8 fas fa-stream p-2 bg-gray-200 rounded-full inline-block" />-->
<!--          <span class="mx-1">{{ $t('buryadLocal') }}</span>-->
<!--        </nuxt-link>-->
<!--        <nuxt-link :to="switchLocalePath('ru')" class="px-2 py-1 cursor-pointer hover:bg-gray-200 hover:text-gray-700 text-sm rounded mb-5">-->
<!--          <outline-information-circle-icon class="w-8 fas fa-stream p-2 bg-gray-200 rounded-full inline-block" />-->
<!--          <span class="mx-1">{{ $t('russianLocal') }}</span>-->
<!--        </nuxt-link>-->
      </div>
    </div>
  </nav>
